var scriptName = "MaratCriticals"; // The name of your script
...
var MaratCriticals = new MaratCriticals();

function onLoad() {}

function onEnable() {
    moduleManager.registerModule(MaratCriticals);
};

function onDisable() {
    moduleManager.unregisterModule(MaratCriticals);
};
