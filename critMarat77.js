var scriptName = "critMarat77"; // The name of your script
var scriptVersion = 1.2; // The version of your script 
var scriptAuthor = "asadullohsss"; // The author of your script (eg. your username)
...
function critMarat77() {
    var mode = value.createList("Mode", ["CustomPacket", "CustomMotion", "NoGround", "Matrix-TPHop","NCP","Redesky", "Horizon", "Spartan", "Hypixel", "Maratcrit"], "Maratcrit")
...
var Criticalz = new critMarat77();

function onLoad() {}

function onEnable() {
    moduleManager.registerModule(critMarat77);
};

function onDisable() {
    moduleManager.unregisterModule(critMarat77);
};
